...
<body class="bg-light">
                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <form class="needs-validation" action="auth-process.php?action=change_password" method="post">

                                <legend> Change Password</legend>
                                <p class="5">Please enter your current and new password.</p>
                                    <?php
  ...
  Wrong credentials. Please check again.
                                    ...
                                    ?>
                                    <input type="password" placeholder="Current Password" autocomplete="current-password" id="current-password" name="old_pw" class="form-control form-control-lg my-3"
                                        required="required" pattern="^[\w@#$%!\^\&\*\-]+$"/>
                                    <input type="password" placeholder="New Password" autocomplete="new-password" id="new-password" name="new_pw" class="form-control form-control-lg my-3"
                                        required="required" pattern="^[\w@#$%!\^\&\*\-]+$" />
