...
<body>
   ...
   <div class="container">
      <div class="row d-none d-md-block">
         <nav aria-label="breadcrumb" class="navbar navbar-light navbar-expand-md p-3">
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-8 col-lg-5 bg-light p-3 rounded">
         <?php
            ...
            echo '</div>';
				echo '<div class="col-sm-12 col-md-4 col-lg-7">';
				echo '<img class="img-fluid rounded" src="./admin/lib/images/' . $product[0]["FILENAME"] . '" alt="Card image cap"></div>';
         ?>
      ...
      <div class="container mt-3">
         <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
               <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#home"
                  type="button" role="tab" aria-controls="home" aria-selected="true">Description</button>
            </li>
            <li class="nav-item" role="presentation">
               <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                  role="tab" aria-controls="profile" aria-selected="false">More info</button>
            </li>
         </ul>
