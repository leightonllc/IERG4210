   ...
   <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-6 p-lg-6 mx-auto my-5">
         <?php
            ...
            echo '<h1 class="display-4 font-weight-normal">'.$catname[0]["NAME"].'</h1>';
         ?>
         <p class="lead font-weight-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
            lobortis aliquam sapien, eget placerat massa ultricies quis. Donec felis mauris, finibus et eleifend et,
            suscipit nec erat. Etiam non sem tortor. Nam non ipsum posuere, varius turpis ac, venenatis ante. Vestibulum
            consectetur tellus vel elit elementum elementum.</p>
      ...
      <div class="row d-none d-sm-block">
         <nav aria-label="breadcrumb" class="navbar navbar-light navbar-expand-sm p-3">
            ...
            <ul class="navbar-nav mr-auto">
               ...
               <li class="nav-item">
                  <?php
                     echo '<a class="nav-link" href="#">'. $catname[0]["NAME"] .'</a>';
                  ?>
               </li>
            </ul>
         </nav>
