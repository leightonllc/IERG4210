         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                     <a tabindex="0" class="nav-link active d-none d-md-block" href="#" data-bs-toggle="popover" data-bs-trigger="hover" type="button" data-bs-placement="bottom" data-bs-html="true" data-content-id="shoppingcart">Shopping Cart <i class="bi bi-cart"></i></a>
...
if ($catname == null) {
      ...
      echo      '<p class="display-4 font-weight-normal">'.$catname[0]["NAME"].'</p>';
?>
         </div>
