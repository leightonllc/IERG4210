...
<div class="card mx-4 my-2 col-md-6 col-lg-4 col-xl-3">
 ...
 <fieldset>
        ...
        enctype="multipart/form-data">
            ...
            <div> <input class="mb-2 form-control" type="file" id="prod_image" name="file" required="true" onchange="loadFile1(event)" accept="image/jpeg, image/png, image/gif"/> </div>
            <label class="mt-1"> Preview </label>
            <p><div class="image"><img class="thumbnail" id="output1"/></div></p>
...
<fieldset>
        ...
        enctype="multipart/form-data">
            ...
            <div> <input class="form-control" id="prod_inventory" type="text" name="inventory"/> </div>
            <label class="mt-1" for="prod_image"> Image * </label>
            <div> <input class="mb-2 form-control" type="file" id="prod_image" name="file" required="true" onchange="loadFile2(event)" accept="image/jpeg, image/png, image/gif"/> </div>
            <label class="mt-1"> Preview </label>
            <p><div class="image"><img class="thumbnail" id="output2"/></div></p>
