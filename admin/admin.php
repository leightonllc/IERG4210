         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                     <a class="nav-link" aria-current="page" href="../index.php">Back to Store</a>
                  </li>
               </ul>
               <form class="d-flex">
...
<div class="card mx-4 my-2 col-md-6 col-lg-4 col-xl-3">
  <div class="card-body">
    <fieldset>
            ...
            <form class="was-validated" id="cat_insert" method="POST" action="admin-process.php?action=cat_insert"
            enctype="multipart/form-data">
                <label for="catid"> Category *</label>
                <div> <input class="form-control" id="name" type="text" name="name" required="required" pattern="^[\w\- ()]+$" /> </div>
...
<fieldset>
            ...
            <form class="was-validated" id="cat_edit" method="POST" action="admin-process.php?action=cat_edit"
            enctype="multipart/form-data">
            ...
            <div> <select class="form-select" id="catid" name="catid"><?php echo $options; ?></select></div>
                ...
                <div> <input class="form-control" id="name" name="name" type="text" required="required" pattern="^[\w\- ()]+$"/></div>
...
<div class="card mx-4 my-2 col-md-6 col-lg-4 col-xl-3">
 ...
 <fieldset>
            ...
            <form class="was-validated" id="cat_delete" method="POST" action="admin-process.php?action=cat_delete"
            enctype="multipart/form-data">
...
<div class="card mx-4 my-2 col-md-6 col-lg-4 col-xl-3">
 ...
 <fieldset>
        ...
        <form class="was-validated" id="prod_insert" method="POST" action="admin-process.php?action=prod_insert"
        enctype="multipart/form-data">
            <label for="prod_catid"> Category *</label>
            <div> <select class="form-select" id="prod_catid" name="catid" pattern="^\d*$"><?php echo $options; ?></select></div>
            <label class="mt-1" for="prod_name"> Name *</label>
            <div> <input class="form-control" id="prod_name" type="text" name="name" required="required" pattern="^[\w\- ()]+$" /></div>
            <label class="mt-1" for="prod_price"> Price *</label>
            <div> <input class="form-control" id="prod_price" type="text" name="price" required="required" pattern="^\d*$)?[0-9]+"/></div>
            <label class="mt-1" for="prod_desc"> Description *</label>
            <div> <input class="form-control" id="prod_desc" type="text" name="description" required="required"/> </div>
            <label class="mt-1" for="prod_inventory"> Inventory *</label>
            <div> <input class="form-control" id="prod_inventory" type="text" name="inventory" required="required" pattern"^\d*$"/> </div>
            <label class="mt-1" for="prod_image"> Image * </label>
            <div> <input class="mb-2 form-control" type="file" id="prod_image" name="file" required="required" onchange="loadFile1(event)" accept="image/jpeg, image/png, image/gif"/> </div>
...
<fieldset>
        ...
        <form class="was-validated" id="prod_edit" method="POST" action="admin-process.php?action=prod_edit"
        enctype="multipart/form-data">
            ...
            <div> <input class="form-control" id="prod_name" type="text" name="name" required="required" pattern="^[\w\- ()]+$"/></div>
            <label class="mt-1" for="prod_price"> Price *</label>
            <div> <input class="form-control" id="prod_price" type="text" name="price" required="required" pattern="^\d*$"/></div>
            <label class="mt-1" for="prod_desc"> Description *</label>
            <div> <input class="form-control" id="prod_desc" type="text" name="description" required="required"/> </div>
            <label class="mt-1" for="prod_inventory"> Inventory *</label>
            <div> <input class="form-control" id="prod_inventory" type="text" name="inventory" required="required" pattern="^\d*$"/> </div>
            <label class="mt-1" for="prod_image"> Image * </label>
            <div> <input class="mb-2 form-control" type="file" id="prod_image" name="file" required="required" onchange="loadFile2(event)" accept="image/jpeg, image/png, image/gif"/> </div>
            <label class="mt-1"> Preview </label>
...
<fieldset>
            ...
            <form class="was-validated" id="prod_delete" method="POST" action="admin-process.php?action=prod_delete"
            enctype="multipart/form-data">
            <label for="pid"> Select Product*</label>
            <div> <select class="form-select" id="pid" name="pid"><?php echo $prodoptions; ?></select></div>
            <button type="submit" class="btn btn-primary mt-2">Delete</button>
